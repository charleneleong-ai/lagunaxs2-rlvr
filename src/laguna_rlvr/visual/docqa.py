...
@app.command()
def main(n: int = 8, seed: int = 0) -> None:
    """Score the OCR->Laguna doc-QA baseline on `n` synthetic forms (the bar the adapter must beat)."""
    ...
    print(f"\nDoc-QA accuracy: {correct}/{n} = {correct / n:.2%}", flush=True)
